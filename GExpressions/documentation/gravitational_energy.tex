...
\end{eqnarray*}
Der symmetrische Energie-Impuls-Tensor, der auch in die Einsteinsche Gleichung $G^{\mu\nu}=\kappa T^{\mu\nu}$ eingeht, lautet in gemischter Form:
\begin{eqnarray*}
...
\qed
\end{proof}
Die Tensor-Dichte \ref{canonic_energy_momentum_density} beschreibt in allen Fällen vier Erhaltungsgrößen
\begin{eqnarray*}
...
\begin{eqnarray*}
g^{\mu\lambda}\Gamma^\nu_{\mu\nu,\tau}-g^{\mu\nu}\Gamma^\lambda_{\mu\nu,\tau}+R\delta^\lambda_\tau &=&
\frac{1}{2}\eta^{\mu\lambda}\eta^{\nu\sigma}\xi_{\nu\sigma,\mu\tau}
-\eta^{\mu\nu}\eta^{\lambda\sigma}\Gamma_{\mu\nu\sigma,\tau}+R^\lambda_\tau\\
&=&\xi^{,\lambda}_{,\tau}-\frac{1}{2}\eta^{\mu\nu}\eta^{\lambda\sigma}\left(\xi_{\sigma\nu,\mu\tau}+\xi_{\mu\sigma,\nu\tau}-\xi_{\mu\nu,\sigma\tau}\right)+R\delta^\lambda_\tau\\
&=&\xi^{,\lambda}_{,\tau}-\eta^{\mu\nu}\eta^{\lambda\sigma}\left(\xi_{\sigma\nu,\mu\tau}-\frac{1}{2}\xi_{\mu\nu,\sigma\tau}\right)+R\delta^\lambda_\tau\\
&=&\xi^{,\lambda}_{,\tau}-\xi^{\lambda,\nu}_{\nu,\tau}+\frac{1}{2}\xi^{,\lambda}_{,\tau}+R\delta^\lambda_\tau\\
&=&\xi^{,\lambda}_{,\tau}-\xi^{\lambda,\nu}_{\nu,\tau}+\frac{1}{2}\xi^{,\lambda}_{,\tau}-\frac{1}{2}\xi^{,\alpha}_{,\alpha}\delta^\lambda_\tau
\end{eqnarray*}
Mit der Eichbedingung
\begin{eqnarray*}
\xi^{\lambda,\nu}_{\nu} = \frac{1}{2}\xi^{,\lambda} 
\end{eqnarray*}
wird
\begin{eqnarray*}
\xi^{\lambda,\nu}_{\nu,\tau} = \frac{1}{2}\xi^{,\lambda}_{,\tau}
\end{eqnarray*}
und wir erhalten
\begin{eqnarray*}
g^{\mu\lambda}\Gamma^\nu_{\mu\nu,\tau}-g^{\mu\nu}\Gamma^\lambda_{\mu\nu,\tau}+R\delta^\lambda_\tau &=&
\xi^{,\lambda}_{,\tau}-\frac{1}{2}\xi^{,\lambda}_{,\tau}+\frac{1}{2}\xi^{,\lambda}_{,\tau}-\frac{1}{2}\xi^{,\alpha}_{,\alpha}\delta^\lambda_\tau\\
&=&\xi^{,\lambda}_{,\tau}-\frac{1}{2}\xi^{,\alpha}_{,\alpha}\delta^\lambda_\tau
\end{eqnarray*}
Mit der Definition
\begin{eqnarray*}
\tilde{\xi}^\mu_\nu &=& \xi^\mu_\nu-\frac{1}{2}\xi\delta^\mu_\nu\\
\tilde{\xi} &=& \xi-2\xi = -\xi\\
\xi^\mu_\nu &=& \tilde{\xi}^\mu_\nu-\frac{1}{2}\tilde{\xi}\delta^\mu_\nu
\end{eqnarray*}
Dreht sich das Vorzeichen um:
\begin{eqnarray*}
g^{\mu\lambda}\Gamma^\nu_{\mu\nu,\tau}-g^{\mu\nu}\Gamma^\lambda_{\mu\nu,\tau}+R\delta^\lambda_\tau
&=&-\tilde{\xi}^{,\lambda}_{,\tau}+\frac{1}{2}\tilde{\xi}^{,\alpha}_{,\alpha}\delta^\lambda_\tau
\end{eqnarray*}
Für den Newtonschen Grenzfall gilt :
\begin{eqnarray*}
\xi_{\mu\nu} &=& \frac{-2}{c^2}\phi\delta^0_\mu\delta^0_\nu
\end{eqnarray*}
